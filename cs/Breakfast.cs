...
namespace cs {
    ...
    public class Breakfast {
        ...
        public static async Task FryEggsAsync(int numEggs) {
            ...
            await Task.Delay(2000); // await means go back to caller and continue code there, come complete this later
        ...
        public static async Task HaveBreakfastAsync() {
        ...
        public static void BreakfastMain(string [] args) {
            Task breakfast = HaveBreakfastAsync();
            breakfast.Wait();
            // work(4.0);
